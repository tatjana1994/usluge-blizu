      ...
      <section className='border-b border-[var(--border)] bg-[var(--background)] py-14 lg:py-16'>
        <Container>
          <div className='grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]'>
            <SectionCard className='border-stone-200 bg-white/95 p-6 shadow-sm lg:p-8'>
            ...
            <SectionCard className='border-stone-200 bg-white/95 p-6 shadow-lg lg:p-8'>
              <p className='text-md font-medium text-rose-600'>
                Najčešća pitanja
              </p>
              <h2 className='mt-2 text-3xl font-semibold tracking-tight text-stone-900'>
      ...
      <section className='bg-[var(--background)] py-14 lg:py-16'>
        <Container>
          <div className='rounded-3xl border border-rose-200 bg-[#fff1ea] px-8 py-10 lg:px-12 lg:py-12'>
            <div className='flex justify-between w-full gap-8 flex-col lg:flex-row lg:items-center'>
              <div>
