        ...
        <Container className='relative max-w-7xl py-16 pb-24 lg:py-20 lg:pb-32'>
          ...
          <div className='grid gap-4 lg:grid-cols-[minmax(0,1fr)_380px]'>
            <div className='space-y-8'>
              <div className='rounded-3xl border border-stone-200 bg-white p-4 shadow-md lg:p-10'>
              ...
              <div className='rounded-3xl border border-stone-200 bg-white p-4 shadow-sm lg:p-4'>
            ...
            <aside className='h-fit self-start'>
              <div className='rounded-3xl border border-stone-200 bg-white p-4 shadow-md'>
