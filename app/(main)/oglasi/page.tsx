    ...
    <main className='min-h-screen bg-[var(--background)]'>
      <section className='relative border-b border-[var(--border)] bg-[#fff7f2]'>
        ...
        <Container className='relative max-w-7xl pt-16 lg:mt-20 lg:mb-8'>
          <div className='mb-10 grid gap-4 rounded-[32px] border border-rose-100 bg-white/55 p-4 shadow-sm backdrop-blur-sm lg:grid-cols-[minmax(0,1fr)_320px] lg:items-end lg:p-4'>
            <div>
                    ...
                    {listings.map((listing) => {
                      ...
                      return (
                        <Link
                          ...
                          className='group block rounded-[28px] border border-stone-200 bg-white px-4 py-6 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-rose-200 hover:shadow-md sm:px-7'
                        >
